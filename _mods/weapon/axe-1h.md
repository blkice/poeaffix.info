...
- effect_text: '#% of Fire Damage Leeched as Life'
  ...
  - effect_text: 0.2% of Fire Damage Leeched as Life
    ...
    spawn_chance: 2.33%
    spawn_weight: 200
- effect_text: 'Grants level # Vulnerability Skill'
  id: GrantedSkill
  mods:
  - effect_text: Grants level 10 Vulnerability Skill
    id: VulnerabilitySkillCorrupted
    name: ''
    required_level: 31
    spawn_chance: 11.63%
    spawn_weight: 1000
...
- effect_text: '#% increased Stun Duration on Enemies'
  ...
  - effect_text: (31-35)% increased Stun Duration on Enemies
    ...
    spawn_chance: 1.22%
    spawn_weight: 1000
- effect_text: '#% reduced Enemy Stun Threshold'
  id: StunThresholdReduction
  mods:
  - effect_text: (5-7)% reduced Enemy Stun Threshold
    id: StunThresholdReduction1
    name: of the Pugilist
    required_level: 5
    spawn_chance: 1.22%
    spawn_weight: 1000
  - effect_text: (8-9)% reduced Enemy Stun Threshold
    id: StunThresholdReduction2
    name: of the Brawler
    required_level: 20
    spawn_chance: 1.22%
    spawn_weight: 1000
  - effect_text: (10-11)% reduced Enemy Stun Threshold
    id: StunThresholdReduction3
    name: of the Boxer
    required_level: 30
    spawn_chance: 1.22%
    spawn_weight: 1000
  - effect_text: (12-13)% reduced Enemy Stun Threshold
    id: StunThresholdReduction4
    name: of the Combatant
    required_level: 44
    spawn_chance: 1.22%
    spawn_weight: 1000
  - effect_text: (14-15)% reduced Enemy Stun Threshold
    id: StunThresholdReduction5
